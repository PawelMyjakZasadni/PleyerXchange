...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container">
    ...
    <div class="card-body">
        <h4> add club 
            <a href="<?= base_url('ofert') ?>" class="btn btn-danger float-right" > back</a>
        </h4>
        <?php
        ...
        ?>
        <form action="<?=base_url('ofert-store') ?>" method="POST">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="form-group">
                        <button type="submit" class="ntm btn-primary px-4" > oferta</button>
                           </div>
